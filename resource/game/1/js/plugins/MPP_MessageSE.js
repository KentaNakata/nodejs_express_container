 ...
 *   \TE[n]        # Change letter SE to n / 0 with no SE
 * 
 ...
 *   - The control character \TE is temporary, but in the case of a
 ...
 *   - 文字SEをn番に変更します。
 *   - デフォルト値は1です。
 *   - 制御文字\TEは一時的なものですが、プラグインコマンドの場合は実行後全ての
 *     文章表示に適用されます。
 * 
 * ================================
